...
public class ArenaFileParserTest {
    ...
    public void basicParsing() throws IntelliJCoderException {
        ...
        assertThat("jars", appletInfo.getClassPath(),
                equalTo("http://www.topcoder.com/contest/classes/7.0/arena-client-7.0.0.jar" + System.getProperty("path.separator") + "http://www.topcoder.com/contest/classes/7.0/basic_type_serialization-1.0.1.jar"));
